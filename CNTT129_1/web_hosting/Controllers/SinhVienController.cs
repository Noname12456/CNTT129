...
namespace CNTT129.Controllers
{
    public class SinhVienController : Controller
    {
        ...
        public JsonResult saveHdNgoai2(string cartModel)
        {
            ...
            return Json(new
            {
                res = hdn.save(jsonCart[0]["id_hd"], jsonCart[0]["noi_dung"], jsonCart[0]["dia_diem"], idhk, jsonCart[0]["hinh_anh"], jsonCart[0]["sinh_vien"], Session["id_gv"].ToString(), "1", jsonCart[0]["lhdn_edit"]),
            });
        }
