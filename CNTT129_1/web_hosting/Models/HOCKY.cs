...
namespace CNTT129.Models
{
    public class HOCKY
    {
        ...
        public int updateDiem(string idhk, string diem, string diemmd)
        {
            ...
            con.Open();
            SqlCommand cmd11 = new SqlCommand("INSERT INTO KETQUA(IDSV,IDHK,DIEMMD,DIEM,LOAI) select ID_SV," + idhk + "," + diemmd + ",0,'B' from SINHVIEN where disabled = 0 and ID_SV NOT IN (SELECT IDSV FROM KETQUA WHERE IDHK = " + idhk + ") ", con);
